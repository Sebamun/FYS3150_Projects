...
int main(int argc, char* argv[])
{
  ...
  double u[num_int + 1], f[num_int - 1];
    ...
    cout << "Time elapsed for backward:" << "\t" << time1 << "s at dx=1/" << factor << endl;
    ...
    cout << "Time elapsed for crank:" << "\t" << time2 << "s at dx=1/" << factor << endl;
    ...
    cout << "Time elapsed for forward:" << "\t" << time3 << "s at dx=1/" << factor << endl;
}
